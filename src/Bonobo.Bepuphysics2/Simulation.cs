...
public partial class Simulation : IDisposable
{
    ...
    /// </summary>
    /// <remarks>
    /// While <see cref="Bonobo.Bepuphysics2.Collidables.Shapes"/> instances can be shared between multiple <see cref="Simulation"/> instances, there are no guarantees of thread safety.
    ...
    /// <param name="shapes">Collection of shapes to use in the simulation, if any. If null, a new <see cref="Bonobo.Bepuphysics2.Collidables.Shapes"/> collection will be created for this simulation.</param>
