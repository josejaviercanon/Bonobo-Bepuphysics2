...
using static Bonobo.BepuUtilities.QuaternionWide;
using static Bonobo.BepuUtilities.Vector3Wide;
using static Bonobo.BepuUtilities.Symmetric3x3Wide;
using static Bonobo.BepuUtilities.Matrix3x3Wide;
using static Bonobo.BepuUtilities.GatherScatter;


namespace Bonobo.Bepuphysics2.Constraints
{
    /// <summary>
